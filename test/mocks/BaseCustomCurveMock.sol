...
contract BaseCustomCurveMock is BaseCustomCurve, ERC20 {
    ...
    ) internal virtual override returns (uint256 unspecifiedAmount) {
    ...
    ) internal virtual override returns (uint256 swapFeeAmount) {
        return 0;
    }
    ...
    ) internal pure override returns (uint256 amount0, uint256 amount1, uint256 liquidity) {
